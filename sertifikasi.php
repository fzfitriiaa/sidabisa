    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="kerjasama.php"><h2>Sertifikasi Sekolah</h2></a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-8">
                        <a href="add_sertifikasi.php" type="submit" class="btn waves-effect waves-light btn-rounded btn-primary" style="margin-left: -15px;" name="submit" value="submit">Tambah Data</a>
                    </div>
                    <br> <br>
                    <table id="zero_config" class="table table-striped table-hover">
                        <thead class="bg-info text-white">
                            <tr>
                                ...
                                <th style="vertical-align : middle;text-align:center;">Status Sertifikasi</th>
                                <th style="vertical-align : middle;text-align:center;">Status TUK</th>
                                <th style="vertical-align : middle;text-align:center;">Program Keahlian yang Telah Sertifikasi</th>
                                <th style="vertical-align : middle;text-align:center;">Jumlah Siswa</th>
                                <th style="vertical-align : middle;text-align:center;">Lembaga Sertifikasi</th>
                                <th style="vertical-align : middle;text-align:center;">Status Lulus Semua</th>
                                <th style="vertical-align : middle;text-align:center;">Jumlah Siswa Lulus</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                $npsn = $_SESSION['npsn'];
                                $query1 = "SELECT id, a.npsn, a.status, a.status_tuk, kompetensi, jml_siswa, lembaga, status_lulus, jml_lulus 
                                FROM tb_sertifikasi as a JOIN tb_kompetensi as b ON a.id_kompetensi=b.id_kompetensi JOIN tb_sekolah as c ON a.npsn=c.npsn
                                WHERE a.npsn=$npsn";
                                ...
                                while($show=$result->fetch_object()){?>
                                    <tr>
                                        ...
                                        <td><?php echo $show->status_tuk; ?></td>
                                        <td><?php echo $show->kompetensi; ?></td>
                                        <td><?php echo $show->jml_siswa; ?></td>
                                        <td><?php echo $show->lembaga; ?></td>
                                        <td><?php echo $show->status_lulus; ?></td>
                                        <td><?php echo $show->jml_lulus; ?></td>
                                        <td>
                                        <a class="btn waves-effect waves-light btn-rounded btn-outline-info" href="edit_sertifikasi.php?id=<?php echo $show->id;?>">Edit</a> 
                                        <a class="btn waves-effect waves-light btn-rounded btn-outline-danger" href="hapus_sertifikasi.php?id=<?php echo $show->id;?>"
